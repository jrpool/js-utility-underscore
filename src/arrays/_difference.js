/*
  Function declaration for _difference and export statement making that
  ...
  Preconditions:
    ...
    1. All arguments are nonsparse arrays, none of whose elements in an array,
      function, or object.
*/
export default function _difference() {
  ...
  arg0: for (let k = 0; k < arguments[0].length; k++) {
    ...
    for (let l = 1; l < arguments.length; l++) {
      // If it includes the element of argument 0:
      if (arguments[l].includes(arguments[0][k])) {
        // Stop checking the element of argument 0.
        continue arg0;
      }
    }
    // All other arguments fail to include the element of argument 0.
